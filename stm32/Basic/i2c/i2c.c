...
int I2C_SAND_BUFFER(u8 SlaveAddr,u8 WriteAddr,u8* pBuffer,u8 NumByteToWrite){ //I2C发送数据串（器件地址，寄存器，内部地址，数量）
...
int I2C_READ_BUFFER(u8 SlaveAddr,u8 readAddr,u8* pBuffer,u8 NumByteToRead){ //I2C读取数据串（器件地址，寄存器，内部地址，数量）
